...
const PrintTreasurePage = (props: PrintTreasurePageProps) => {
    ...
    const renderTarget = (target: MapCoordinate) => {
        const mapStep =
            numberRange === 10 ? parentHeight / 14 : parentHeight / 28;
        ...
        return (
            ...
            >
                <Stone height={mapStep} width={mapStep} />
            </div>
        );
    };
    ...
    return (
        <div
            className="flexRow"
            style={{ width: (3 * parentHeight) / 2 + 'px' }}
        >
            <img
                src={gridSrc}
            ...
            <div className="printPageText">
                <span className="printEquation">
                    <FormattedMessage id="worksheetDesc1" />
                </span>
                <span className="printEquation">
                    <FormattedMessage id="worksheetDesc2" />
                </span>
                <span className="printEquation">
                    <FormattedMessage id="worksheetDesc3" />
                </span>
