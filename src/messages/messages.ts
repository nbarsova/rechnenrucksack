export const enMessagesJson = {
    ...
    "secretMessageTooLong": "Secret message must not be longer than {limit} symbols",
...
export const deMessagesJSON = {
    ...
    "secretMessageTooLong": "Geheime Nachricht darf nicht länger als {limit} Symbole sein",
...
export const ruMessagesJSON = {
    ...
    "secretMessageTooLong": "Секретное сообщение не должно быть длиннее {limit} символов",
